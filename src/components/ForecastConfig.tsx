  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="config-grid">
        ...
        <div className="form-group">
          <label htmlFor="country_holidays">Country Holidays</label>
          <select
            id="country_holidays"
        ...
        <div className="form-group">
          <label htmlFor="forecast_method">Forecasting Method</label>
          <select
            id="forecast_method"
        ...
        <div className="form-group">
          <label htmlFor="changepoint_prior_scale">Trend Flexibility</label>
          <input
            type="number"
        ...
        <div className="form-group">
          <label htmlFor="seasonality_prior_scale">Seasonality Strength</label>
          <input
            type="number"
